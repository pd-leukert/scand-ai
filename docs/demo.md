...
4. **The thing it does unasked.** *(Pending the team's choice, [Q1](open-questions.md). One
   candidate is proposed: flag statements meant to be private — see [roadmap.md](roadmap.md)
   and D28.)*
