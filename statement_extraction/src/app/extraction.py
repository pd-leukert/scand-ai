...
Never turn an attachment placeholder into a statement — a bare "Image" on its own line, \
"[Image removed by sender]", "[cid:image001.png]", or "Bild borttagen av avsändaren". Never \
turn a signature block, a marketing footer, or a "SYNTHETIC DATA" banner into one either. \
These are holes in the record, not claims.\
"""
